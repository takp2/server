...
enum ClientVersion { cv_old };

enum MacClientVersion { unused = 1, pc = 2, intel = 4, ppc = 8 };
...
enum LoginMode { lm_initial = 2, lm_from_world = 3 };
...
class Client {
   public:
	...
	/**
	 * Sends a packet to the requested server to see if the client is allowed or
	 * not.
	 */
