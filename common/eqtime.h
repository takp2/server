...
class EQTime {
   public:
	...
	// Get functions
	int getEQTimeOfDay(TimeOfDay_Struct *eqTimeOfDay) {
		return (getEQTimeOfDay(time(nullptr), eqTimeOfDay));
	}
	...
	static bool IsTimeBefore(TimeOfDay_Struct *base,
	                         TimeOfDay_Struct *test);  // is test before base
