...
#define LogQuestErrorsDetail(message, ...)                                                                       \
	do {                                                                                                         \
		if (LogSys.log_settings[Logs::QuestErrors].is_category_enabled = 1)                                      \
...
#define LogEQMac(message, ...) \
	do {                       \
	} while (0)

#define LogEQMacDetail(message, ...) \
	do {                             \
	} while (0)
