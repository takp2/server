...
MySQLRequestRow::MySQLRequestRow() : m_Result(nullptr), m_MySQLRow(nullptr) {}
...
MySQLRequestRow MySQLRequestRow::operator*() { return *this; }

MySQLRequestRow::MySQLRequestRow(MYSQL_RES* result) : m_Result(result) {
	if (result != nullptr)
...
char* MySQLRequestRow::operator[](int index) { return m_MySQLRow[index]; }
