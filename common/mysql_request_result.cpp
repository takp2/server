...
MySQLRequestResult::MySQLRequestResult() : m_CurrentRow(), m_OneBeyondRow() {
	ZeroOut();
}

MySQLRequestResult::MySQLRequestResult(MYSQL_RES* result, uint32 rowsAffected,
...
MySQLRequestResult::~MySQLRequestResult() { FreeInternals(); }
